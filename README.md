...
## 🧠 About Me
- 🔭 Building real-world AI/ML & GenAI projects  
- 🤖 Specialized in LLMs, RAG Systems & Backend APIs  
- ⚡ Strong focus on **practical, production-level implementations**  
- 📈 Transitioning into AI/ML Engineering through hands-on projects  
- 💡 Interested in AI, Business, and Scalable Systems  
...
**📊 Data & Analysis**
- NumPy, Pandas, EDA, Data Cleaning  
- Matplotlib, Seaborn  
...
- Built using LangChain, OpenAI, FAISS & FastAPI  
- Supports document Q&A with conversational memory  
- Streamlit UI + deployed system  

---

### 🏠 House Price Prediction
👉 https://github.com/jacobabhihail-tech/ml-house-price-prediction  
- ML regression pipeline using Scikit-learn  
- Feature engineering + model evaluation  

---

### 📉 Customer Churn Prediction
👉 https://github.com/jacobabhihail-tech/customer-churn-prediction-ml  
- Classification models with tuning & evaluation  
- Feature importance analysis  

---

### 💬 Sentiment Analysis (Deep Learning)
👉 https://github.com/jacobabhihail-tech/dl-sentiment-analysis  
- NLP model using TensorFlow/Keras  
- Text preprocessing + classification  

---

### ⚡ FastAPI ML Deployment
👉 https://github.com/jacobabhihail-tech/fastapi-ml-deployment  
- ML model deployed as REST API  
...
![GitHub Streak](https://streak-stats.demolab.com?user=jacobabhihail-tech)

---

## 📚 Currently Learning
- Advanced Generative AI (RAG, Agents, LLM Optimization)  
...
## 🌍 Connect With Me
- 💼 LinkedIn: https://www.linkedin.com/in/abin-jacob-a93622335/  
- 📧 Email: Jacob.abhihail@gmail.com  

---

⭐ *Building AI systems, not just projects.*
